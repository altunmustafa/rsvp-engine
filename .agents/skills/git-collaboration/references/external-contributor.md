...
For cleanup, verify the canonical PR was merged. With a clean tree, delete only the confirmed local topic branch. Force local deletion only after a verified squash or rebase merge that Git cannot detect by ancestry.
